...
window.AdOps.videobox = function(options) {
    ...
    var config = {
		stage: '#VideoBox_Stage',
        video: '#VideoBox_Video',
		controls: '#VideoBox_Controls',
        close: '.ad-close',
        mute: '.ad-mute',
        unmute: '.ad-unmute',
        click: '.ad-click',
        clickUrl: decodeURIComponent(qs.clickTag || qs.clickTAG || 'http://www.example.com'),
        poster: false,
    ...
    return {
        ...
        init: function() {
			...
			//Handle Video Button
            ads.helper.query(config.controls + ' .video', function(el) {
			...
			//Handle Audio Button
            ads.helper.query(config.controls + ' .audio', function(el) {
            ...
            ads.helper.query(config.controls + ' .restart', function(el) {
