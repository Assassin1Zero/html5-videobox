...
window.AdOps.videobox = function(options) {
    ...
    return {
        ...
        init: function() {
			...
			//Handle Video Button
            ads.helper.query('#VideoBox_Controls .video', function(el) {
			...
			//Handle Audio Button
            ads.helper.query('#VideoBox_Controls .audio', function(el) {
            ...
            ads.helper.query('#VideoBox_Controls .restart', function(el) {
