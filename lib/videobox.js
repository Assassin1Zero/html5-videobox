...
window.AdOps.videobox = function(options) {
    ...
    return {
        ...
        init: function() {
			...
			//Handle Video Button
            ads.helper.query(config.stage + ' > #Controls .video', function(el) {
			...
			//Handle Audio Button
            ads.helper.query(config.stage + ' > #Controls .audio', function(el) {
            ...
            ads.helper.query(config.stage + ' > #Controls .restart', function(el) {
